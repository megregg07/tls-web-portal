...
{: style="display: flex; justify-content: center; flex-wrap: nowrap; text-align: center; gap: 45px; list-style-type: none; margin: 20px auto; max-width: 900px;"}
...
<div style="display: flex; justify-content: center; align-items: center; flex-wrap: wrap; gap: 15px; padding-top: 10px;">
  ...
  <a href="https://www.nist.gov/osac" target="_blank" style="display: flex; align-items: center; text-decoration: none; color: #555; font-size: 0.85em; font-weight: bold;">
    ...
    <span style="max-width: 280px; text-align: left; display: inline-block; line-height: 1.3;">
